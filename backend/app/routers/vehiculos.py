...
def vehiculo_con_transportista_por_placas(
    ...
    return VehiculoConTransportistaRespuesta(
        ...
        cert_tracto=veh_tracto.cert_tracto,
        cert_carreta=veh_tracto.cert_carreta,
        configuracion_vehicular=veh_tracto.configuracion_vehicular,
        largo_tracto=veh_tracto.largo_tracto,
        ancho_tracto=veh_tracto.ancho_tracto,
        alto_tracto=veh_tracto.alto_tracto,
        largo_carreta=veh_tracto.largo_carreta,
        ancho_carreta=veh_tracto.ancho_carreta,
        alto_carreta=veh_tracto.alto_carreta,
