...
class VehiculoConTransportistaRespuesta(BaseModel):
    """Vehículo con transportista (identificado por placa TRACTO; opcional alerta si carreta es de otro)."""
    id: int
    placa_tracto: str
    placa_carreta: Optional[str]
    placas: str
    ...
    carreta_transportista_nombre: Optional[str] = None
