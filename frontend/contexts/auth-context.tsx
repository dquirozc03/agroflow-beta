      ...
      apiMe()
        .then((me) => {
          const u: AuthUser = {
            ...
            permisos: me.permisos || { logicapture: true, maestros: true, operaciones: true, sistema: false }
          };
          setUser(u);
          saveStoredUser(u);
        })
    ...
    async (usuario: string, password: string): Promise<{ ok: boolean; error?: string }> => {
      try {
        ...
        const u: AuthUser = {
          ...
          permisos: res.permisos || { logicapture: true, maestros: true, operaciones: true, sistema: false }
        };
        setUser(u);
        saveStoredUser(u);
        return { ok: true };
